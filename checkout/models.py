...
class Order(models.Model):
    ...
    def update_total(self):
        """ 
        Updates order total when line item is added,
    ...
    def save(self, *args, **kwargs):
        """
        Override original saving method to set order number
...
class OrderLineItem(models.Model):
    ...
    product = models.ForeignKey(Flowers, null=False, blank=False, on_delete=models.CASCADE)
    quantity = models.IntegerField(null=False, blank=False, default=0)
    lineitem_total = models.DecimalField(max_digits=6, decimal_places=2, null=False, blank=False, editable=False)

    def save(self, *args, **kwargs):
        """
        Override original saving method to set lineitem total
